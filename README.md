<img width="365" alt="image" src="https://github.com/user-attachments/assets/4168af47-0134-42a1-a882-16deb02ce760" /># crosswalk_identify
## 斑馬線辨識系統
...
2. 整個斑馬線都要入鏡：由於先前介紹到找尋輪廓時，限制只找四邊形的輪廓，如果有斑馬線輪廓卡在邊緣，就不會是一個四邊形，辨識到的行人穿越線邊界就會不完整~
